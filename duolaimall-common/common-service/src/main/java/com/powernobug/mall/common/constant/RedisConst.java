...
public class RedisConst {
    ...
    public static final String USER_CART_KEY_SUFFIX = "user:cart:";
    ...
    public static final String PROMO_SECKILL_GOODS_STOCK = "promo:goods:stock";
    // 秒杀商品库存状态位
    ...
    public static final String PROMO_WORDS_SEPARATOR = ":";
